...
const LS_KEY = 'sakanak_policy_agreed_v2'; // تغيّر المفتاح عشان يظهر للزوار القدامى من جديد
        ...
        >
          <div className="space-y-5 pb-2 text-sm leading-relaxed text-foreground/90">
            ...
            <div className="rounded-xl border border-emerald-300/60 bg-emerald-50 p-3 text-center text-emerald-900">
              ...
              <p className="text-xs mt-1">المنصة تتحصل على <b>25%</b> فقط من الطالب كرسوم حجز وتأكيد.</p>
            </div>
            ...
            <section className="space-y-2">
              ...
              <p>
                ...
                نسبة المنصة وهي <b>25% من قيمة الإيجار الشهري</b>، خلال <b>48 ساعة (يومان)</b> كحد أقصى من لحظة
            ...
            <section className="space-y-2">
              ...
              <p>
                <b>إلغاء الإعلان:</b> يحق للمالك إلغاء إعلانه في أي وقت <b>قبل قيام أي طالب بدفع رسوم الحجز</b>، 
                بدون أي غرامات أو رسوم إضافية، لأن الإعلان مجاني.
              </p>
              <p className="rounded-lg border border-amber-300/60 bg-amber-50 p-3 text-amber-900">
                <b>إلغاء الإعلان بعد دفع الطالب:</b> إذا قام طالب بدفع رسوم الحجز (25%) وقام المالك بإلغاء الإعلان بعد ذلك، 
            ...
            <section className="space-y-2">
              ...
              <p>
                ...
                يسترد الطالب نسبة الـ 25% كاملة وفورًا.
              </p>
              <p>
            ...
            <section className="space-y-2">
              ...
              <div className="overflow-hidden rounded-xl border border-border">
                <table className="w-full text-xs">
                  <tbody>
                    {[
                      ['نسبة عمولة المنصة (من الطالب)', '25% من قيمة الإيجار الشهري'],
                      ...
                      ['نسبة استرجاع المالك عند الإلغاء', 'غير مستردة (الإعلان مجاني)'],
