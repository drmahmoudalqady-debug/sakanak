...
const LS_KEY = 'sakanak_policy_agreed_v4'; // تغيّر المفتاح عشان يظهر للزوار القدامى من جديد
          ...
          <div className="space-y-5 pb-2 text-sm leading-relaxed text-foreground/90">
            ...
            <section className="space-y-2">
              ...
              <p className="rounded-lg border border-rose-300/60 bg-rose-50 p-3 text-rose-900">
                ...
                المالك، مما أدى إلى تراجع الطالب واسترداده لنسبة الـ 25% التي دفعها للمنصة، يتم فرض <b>غرامة مالية على المالك تتراوح بين 7% و10% كحد أقصى</b> (حسب قدر الخطأ وشدته)، ويتحمل المالك كامل المسؤولية القانونية والمالية تجاه الطالب. <b>لا يتم حظر المالك من المنصة.</b>
              </p>
            </section>
            ...
            <section className="space-y-2">
              ...
              <p className="rounded-lg border border-amber-300/60 bg-amber-50 p-3 text-amber-900">
                ...
                يتم فرض <b>غرامة 7%</b> على المالك كتعويض لإهدار وقت الطالب والمنصة، ويلتزم برد كامل المبلغ المستحق للطالب. <b>لا يتم حظر المالك من المنصة.</b>
              </p>
            </section>
            ...
            <section className="space-y-2">
              ...
              <div className="overflow-hidden rounded-xl border border-border">
                <table className="w-full text-xs">
                  <tbody>
                    {[
                      ['نسبة عمولة المنصة (من الطالب)', '25% (12.5% تأكيد + 12.5% معاينة)'],
                      ...
                      ['غرامة المالك (وصف خاطئ)', '7% إلى 10% كحد أقصى (حسب الخطأ)'],
                      ['غرامة المالك (إلغاء بعد دفع الطالب)', '7% — + رد المبلغ للطالب'],
                      ['إعادة النشر بعد اعتراض غير مبرر', '25% مقدمًا من المالك — تُسترد بعد التسكين'],
                    ].map(([label, value], i) => (
